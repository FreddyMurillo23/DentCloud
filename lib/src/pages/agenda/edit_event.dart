...
class EditEvent extends StatefulWidget {
  final EventosModeloHold eventosModeloGlobal;
  final CurrentUsuario currentuser;
  final Servicios nuevo;
  
  EditEvent({Key key, this.eventosModeloGlobal, this.currentuser, this.nuevo}) : super(key: key);
                        ...
                        Center(
                          child: Container(
                            ...
                            child: CachedImageWidget(
                              ...
                              image: widget.eventosModeloGlobal.image,
                            ),
                          ),
                        ),
                        SizedBox(height: 10,),
