...
class AgendaWithProvider extends StatefulWidget {
  final CurrentUsuario currentuser;
  const AgendaWithProvider({Key key, this.currentuser}) : super(key: key);
  @override
  _AgendaWithProviderState createState() => _AgendaWithProviderState();
}

class _AgendaWithProviderState extends State<AgendaWithProvider> {
