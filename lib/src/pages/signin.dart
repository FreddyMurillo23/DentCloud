  ...
  showDialog(
    ...
    builder: (BuildContext context){
      return AlertDialog(
        ...
        content: new Image(image: AssetImage("assets/images/fondo2.png"),
            ...
            child: new Container(
              ...
              child: new Form(
                ...
                new RaisedButton(
                      ...
                      onPressed: () => {Navigator.of(context).pushNamedAndRemoveUntil('registrarse', (Route<dynamic> route) => false)},
                      color: Colors.blueAccent,
                      shape: RoundedRectangleBorder(            
                        borderRadius: BorderRadius.circular(18),
                      ),
